...
function CustomerDetail({ customer, contacts, sites, jobs, busy, onSave, onOpenJob }: {
  customer: Customer; contacts: CustomerContact[]; sites: ServiceSite[]; jobs: Job[]; busy: string;
