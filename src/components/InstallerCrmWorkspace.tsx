...
import { browserLocalDateTime } from "@/lib/trade-schedule";
...
function JobDetail({ job, customer, sites, user, busy, teamAccess, onCrm, onWorkOrder, onOpenIntegrations, onReload }: { job: Job; customer?: Customer; sites: ServiceSite[]; user: User; busy: string; teamAccess: boolean; onCrm: (method: "POST" | "PATCH", body: Record<string, unknown>, key: string, success: string) => Promise<boolean>; onWorkOrder: (method: "POST" | "PATCH", body: Record<string, unknown>, key: string, success: string) => Promise<boolean>; onOpenIntegrations: () => void; onReload: () => Promise<void> }) {
