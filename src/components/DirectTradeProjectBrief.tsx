...
const priorities = [
  ...
  ["replace-equipment", "Replace ageing or failed equipment"],
  ["move-from-gas", "Move away from gas"],
  ["solar-storage", "Add solar, storage or backup"],
  ["assessment-compliance", "Assessment or compliance evidence"],
  ["need-advice", "Not sure yet, I need advice"],
] as const;
...
export function DirectTradeProjectBrief() {
  ...
  const [propertyRelationship, setPropertyRelationship] = useState("");
