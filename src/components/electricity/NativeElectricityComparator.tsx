...
type PlanBundle = {
  ...
  source?: {
    ...
    detailPlansTimedOut?: number;
    detailPlansSkipped?: number;
    retailersDiscovered?: number;
    listSourcesSucceeded?: number;
    listSourcesTimedOut?: number;
    listSourcesSkipped?: number;
    ...
    cacheFallbackAgeSeconds?: number;
    cacheRefreshInProgress?: boolean;
    retailerCoverage?: Array<{ retailer: string; listAvailable: boolean; candidatePlans: number; detailsPassed: number; detailsRejected: number; detailsUnavailable: number; detailsTimedOut?: number; detailsSkipped?: number }>;
  };
};
