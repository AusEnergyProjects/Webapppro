...
type TrainingResult = ApiResult & { business: BusinessStatus; memberId: string; trainingServiceStates?: string[]; modules: Module[]; team?: TeamProgress[]; unavailableActivities?: UnavailableActivity[] };
