...
type TeamProgress = { memberId: string; displayName: string; officeOnly?: boolean; modules: { id: string; title: string; serviceCategory?: string; status: string; reference?: string; expiresAt?: string }[] };
...
export function TradeTrainingWorkspace({ user }: { user: User }) {
  ...
  return <div className={styles.shell}>
    ...
    {!data?.officeOnly && data?.trainingServiceStates?.length ? <p className={styles.muted}>Training for {data.trainingServiceStates.join(", ")}, plus relevant national programs. Change states in Business &gt; Services and areas.</p> : null}
