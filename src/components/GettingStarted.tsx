...
export function GettingStarted() {
  return <main className="wrap start-page">
    ...
    <section className="home-support-grid" aria-label="Assessment, support and project help"><article><span>Official support</span><h2>Find rebates, loans and certificate schemes</h2><p>Choose your state or territory, then check eligibility on the official program website before you buy or sign anything.</p><Link href="/rebates">Find rebates and assistance</Link></article><article><span>Independent assessment</span><h2>Find the right assessment for your home or project</h2><p>Tell us whether you are designing, renovating or assessing an existing home. We will show you which assessment applies and what the result can be used for.</p><Link href="/assessments">Explore assessments</Link></article><article><span>Direct Trade Services</span><h2>Get your project ready for quotes</h2><p>With your permission, we can share the details you choose with approved trades that do this type of work and service your area.</p><Link href="/direct-trade">Prepare a project brief</Link><Link style={{ marginTop: 8 }} href="/direct-trade/standards">Read the marketplace standards</Link></article></section>

    <section className="start-privacy"><div><span>Privacy first</span><h2>Start privately, without an account</h2><p>If you add a detailed electricity meter file, called a NEM12 file, it is processed on your device. The file, meter number and detailed readings are not added to saved links or trade enquiries.</p></div><Link href="/plan">Build my private plan</Link></section>
