...
export function GettingStarted() {
  return <main className="wrap start-page">
    ...
    <section className="home-support-grid" aria-label="Assessment, support and project pathways"><article><span>Official support</span><h2>Check rebates without treating them as guaranteed</h2><p>Choose a state or territory, distinguish certificates from rebates and loans, then confirm current rules at the official source.</p><a href="/rebates">Find rebates and assistance</a></article><article><span>Independent assessment</span><h2>Use NatHERS, BASIX or an existing-home rating where it fits</h2><p>Choose the correct pathway for a design, renovation, built home or NSW planning project before relying on a certificate.</p><a href="/assessments">Explore assessments</a></article><article><span>Direct Trade Services</span><h2>Turn a decision into a defined scope</h2><p>With your clear consent, the selected enquiry details go to every active verified trade whose recorded capability and service area match the work.</p><a href="/direct-trade">Prepare a project brief</a></article></section>
