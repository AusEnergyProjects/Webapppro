...
export function GettingStarted() {
  return <main className="wrap start-page">
    ...
    <section className="start-section" aria-labelledby="upgrade-guides-title"><div className="start-heading"><span>Plan an upgrade</span><h2 id="upgrade-guides-title">Solar and battery guides</h2><p>Understand the evidence, quote details, installer checks and assumptions before choosing equipment.</p></div><div className="start-guide-grid"><a href="/guides/solar"><span>Rooftop solar</span><strong>Match generation to your home</strong><small>Size, self-consumption, exports, quotes and installers</small></a><a href="/guides/batteries"><span>Home batteries</span><strong>Test storage against your load</strong><small>Capacity, power, backup, warranties and federal support</small></a></div></section>
