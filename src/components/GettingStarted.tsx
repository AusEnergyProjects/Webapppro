...
export function GettingStarted() {
  return <main className="wrap start-page">
    ...
    <header className="start-hero">
      <div className="start-hero-copy"><span className="start-eyebrow">Independent energy comparison</span><h1>Make a confident energy decision</h1><p>Start with the energy bill you already have. We will help you choose the right comparison path, understand the assumptions and know what to confirm before changing plans.</p><div className="start-actions"><a className="btn" href="/compare">Compare electricity</a><a className="btn ghost" href="/gas-compare">Compare gas</a></div><aside aria-label="What this service does"><strong>Clear evidence, not a sales ranking</strong><ul><li>Published retailer plan data</li><li>Your household usage where available</li><li>Visible assumptions and calculation audits</li><li>Retailer confirmation before switching</li></ul></aside></div>
      <div className="start-hero-visual" role="img" aria-label="Home energy platform showing solar, a battery, heating and hot water" />
    </header>
