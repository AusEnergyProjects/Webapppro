...
function emailDraft(payload: Record<string, unknown>) {
  ...
  const body = `Hi ${name},\n\nWe received your home upgrade enquiry. Your personalised home energy plan is attached.\n\nApproved TLink trades that match your selected services and service area can now review the details you chose to share. Your private plan and PDF are not shared with trades.\n\nReference: ${reference}\n\nAustralian Energy Assessments\n1300 241 149`;
  const html = `<!doctype html><html><body style="margin:0;background:#eef7f4;font-family:Arial,sans-serif;color:#073b3e"><table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td align="center" style="padding:24px"><table role="presentation" width="620" style="max-width:100%;background:#fff;border-radius:18px;overflow:hidden"><tr><td style="background:#063f47;padding:24px 28px;color:#fff"><div style="font-size:12px;letter-spacing:1.4px;color:#61e3c3;font-weight:700">AUSTRALIAN ENERGY ASSESSMENTS</div><h1 style="font-size:27px;margin:10px 0 0">Your plan is ready</h1></td></tr><tr><td style="padding:28px"><p>Hi ${escapeHtml(name)},</p><p>We received your home upgrade enquiry. Your personalised home energy plan is attached.</p><div style="background:#e9f8f3;border-left:4px solid #0aa77b;padding:14px 16px;margin:22px 0"><strong>What happens next</strong><br>Approved TLink trades that match your selected services and service area can review only the details you chose to share.</div><p>Your private plan and PDF are not shared with trades.</p><p style="font-size:13px;color:#4b6b6d">Reference: ${escapeHtml(reference)}</p><p>Australian Energy Assessments<br>1300 241 149</p></td></tr></table></td></tr></table></body></html>`;
