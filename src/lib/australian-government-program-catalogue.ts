...
export const COMPLIANCE_CLAIM_OUTPUT_CODES = [
  "STC",
  "LGC",
  "REGO",
  "ACCU",
...
export type ComplianceClaimOutputCode =
  typeof COMPLIANCE_CLAIM_OUTPUT_CODES[number];
...
export const GOVERNMENT_PROGRAM_TEMPLATES: readonly GovernmentProgramTemplate[] = [
  ...
  },
  {
    ...
    outcomeClass: "tradable_certificate",
    claimOutputCode: "LGC",
    claimOutputLabel: "Large-scale generation certificates (LGCs)",
    administeringBody: "Clean Energy Regulator",
  ...
  },
  {
    ...
    jurisdiction: "AU",
    outcomeClass: "tradable_certificate",
    claimOutputCode: "REGO",
    claimOutputLabel: "Renewable Electricity Guarantee of Origin certificates (REGOs)",
    administeringBody: "Clean Energy Regulator",
  ...
  },
  {
    ...
    claimOutputCode: "ACCU",
    claimOutputLabel: "Australian carbon credit units (ACCUs)",
    administeringBody: "Clean Energy Regulator",
  ...
  },
  {
    ...
    claimOutputLabel: "Government-supported finance",
  ...
  },
  {
    ...
    claimOutputLabel: "Government procurement program",
  ...
  },
  {
    ...
    jurisdiction: "VIC",
    outcomeClass: "tradable_certificate",
    claimOutputCode: "VEEC",
    claimOutputLabel: "Victorian energy efficiency certificates (VEECs)",
  ...
  },
  {
    ...
    claimOutputLabel: "Government rebate",
  ...
  },
  {
    ...
    claimOutputLabel: "Government grant",
    administeringBody: "Solar Victoria",
  ...
  },
  {
    ...
    outcomeClass: "tradable_certificate",
    claimOutputCode: "ESC",
    claimOutputLabel: "Energy savings certificates (ESCs)",
  ...
  },
  {
    ...
    outcomeClass: "tradable_certificate",
    claimOutputCode: "PRC",
    claimOutputLabel: "Peak reduction certificates (PRCs)",
    administeringBody: "IPART",
  ...
  },
  {
    ...
    claimOutputCode: "EEIS_BENEFIT",
    claimOutputLabel: "EEIS retailer obligation benefit",
  ...
  },
  {
    ...
    claimOutputLabel: "REPS retailer obligation benefit",
...
const NSW_ESS_ACTIVITY_ROWS: Array<[
  ...
  ["D11", "Replace a gas-fired water heater with a high-efficiency gas-fired water heater", "hot-water", "closed"],
  ["D12", "Install or replace a gas space heater with a high-efficiency gas space heater", "heating-cooling", "closed"],
  ...
  ["D21", "Replace gas water heating with solar gas-boosted water heating", "hot-water", "closed"],
  ...
  ["F8", "Install or replace a high-efficiency gas-fired steam boiler", "other", "closed"],
  ["F9", "Install or replace a high-efficiency gas-fired water heater or hot-water boiler", "hot-water", "closed"],
