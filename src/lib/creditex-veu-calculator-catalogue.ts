...
function waterHeaterEligibilityInputDefinitions(
  ...
  return [
    { key: "unit_quantity", label: "Number of identical systems", type: "decimal", unit: "systems", help: "Enter how many separately eligible replacements use this approved model. Each prescribed activity is calculated and rounded to whole VEECs before the property total is added. Schedule 4 permits no more than 2 Part 1 or Part 3 water-heating products at residential premises, or 5 at non-residential premises, including earlier products in the applicable relevant period.", defaultValue: "1", source: "operator", required: true, min: "1", max: "5", step: "1" },
    ...
    { key: "prior_relevant_period_water_heater_products", label: "Previous VEU water-heating products at this property", type: "select", unit: "products", help: "Count Part 1 or Part 3 water-heating products installed at these premises as part of a VEU prescribed activity, whether or not a certificate was created. For a home, count from 10 June 2019 and choose 2 if there were 2 or more. For non-residential premises, count from 31 May 2023 and choose 5 if there were 5 or more. Confirm the property history instead of assuming zero.", defaultValue: "not_confirmed", source: "operator", required: true, options: [{ value: "not_confirmed", label: "Not confirmed yet" }, { value: "0", label: "None" }, { value: "1", label: "1" }, { value: "2", label: "2" }, { value: "3", label: "3" }, { value: "4", label: "4" }, { value: "5", label: "5 or more" }] },
