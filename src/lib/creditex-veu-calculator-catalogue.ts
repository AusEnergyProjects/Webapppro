...
function waterHeaterEligibilityInputDefinitions(
  ...
  return [
    { key: "unit_quantity", label: "Systems using this model", type: "decimal", unit: "systems", help: "Choose how many systems using this approved model are included in this upgrade. The calculator combines their exact reduction before rounding the upgrade total once.", defaultValue: "1", source: "operator", required: true, min: "1", max: "5", step: "1" },
    ...
    { key: "prior_relevant_period_water_heater_products", label: "Earlier VEU water-heater upgrades", type: "select", unit: "products", help: "The customer estimate assumes zero earlier VEU-funded water-heater products at this property. The accredited provider must confirm property history before certificate creation.", defaultValue: "0", source: "operator", required: true, options: [{ value: "not_confirmed", label: "Not confirmed yet" }, { value: "0", label: "None" }, { value: "1", label: "1" }, { value: "2", label: "2" }, { value: "3", label: "3" }, { value: "4", label: "4" }, { value: "5", label: "5 or more" }] },
