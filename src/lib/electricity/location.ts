...
export const DISTRIBUTOR_INFO: Record<string, DistributorInfo> = {
  ...
  CitiPower: { state: "VIC", region: "VIC1", website: "https://www.citipower.com.au/", meterDataUrl: "https://energyeasy.com.au/", meterDataInstructions: "Use Energy Easy, open Reports, and run the Victorian Energy Compare Data report as a CSV." },
  Powercor: { state: "VIC", region: "VIC1", website: "https://www.powercor.com.au/", meterDataUrl: "https://energyeasy.com.au/", meterDataInstructions: "Use Energy Easy, open Reports, and run the Victorian Energy Compare Data report as a CSV." },
  Jemena: { state: "VIC", region: "VIC1", website: "https://www.jemena.com.au/", meterDataUrl: "https://electricityoutlook.jemena.com.au/", meterDataInstructions: "Register for Electricity Outlook, then download your interval usage data." },
  "United Energy": { state: "VIC", region: "VIC1", website: "https://www.unitedenergy.com.au/", meterDataUrl: "https://energyeasy.com.au/", meterDataInstructions: "Use Energy Easy, open Reports, and run the Victorian Energy Compare Data report as a CSV." },
