...
const recommendations = {
  urgent: { id: "urgent", stage: "Do first", title: "Define the urgent replacement before accepting a like-for-like swap", text: "Make failed equipment safe, record what it served and ask a licensed trade to price the efficient electric option as well as any enabling work.", href: "/direct-trade", action: "Prepare an urgent project brief" },
  authority: { id: "authority", stage: "Before quotes", title: "Confirm who can approve changes to the property", text: "Renters and strata residents may need written permission before equipment, wiring, external units, solar or EV charging can change.", href: "/direct-trade", action: "Prepare an authority-aware brief" },
  ...
  brief: { id: "brief", stage: "When the scope is clear", title: "Turn the roadmap into one project brief", text: "Carry the services, priorities, location and approval situation into a privacy-safe brief for manual review and suitable verified capability.", href: "/direct-trade", action: "Build a Direct Trade brief" },
};
