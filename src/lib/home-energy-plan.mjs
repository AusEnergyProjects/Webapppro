...
const recommendations = {
  urgent: { id: "urgent", stage: "Do first", title: "Define the urgent replacement before accepting a like-for-like swap", text: "Make failed equipment safe, record what it served and ask a licensed trade to price the efficient electric option as well as any enabling work.", href: "/guides/project-preparation#urgent-replacement", action: "See what an urgent scope needs" },
  authority: { id: "authority", stage: "Before quotes", title: "Confirm who can approve changes to the property", text: "Renters and strata residents may need written permission before equipment, wiring, external units, solar or EV charging can change.", href: "/guides/project-preparation#permissions", action: "See which permissions to confirm" },
