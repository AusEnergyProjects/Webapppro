...
export default function FieldAppPage() {
  return <main className="tlink-field-app-page">
    ...
    <section className="tlink-field-app-grid">
      ...
      <article><span>03</span><strong>Check for changes</strong><p>Open Account in TLink and choose Check for update. Small releases install in the app; full builds return here securely.</p></article>
    </section>
