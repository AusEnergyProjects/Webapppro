...
export default function DirectTradeStandardsPage() {
  return <main className="wrap direct-trade-standards-page">
    ...
    <section className="standards-actions"><div><span>Choose your path</span><h2>Use the standards before making a connection</h2><p>Households can prepare a project brief. Installers and suppliers can create a business profile for direct review.</p></div><div><a className="btn" href="/direct-trade">Start a household brief</a><a className="btn ghost" href="/direct-trade/partners">Trade and supplier participation</a></div></section>
