...
const description = "Book Australia-wide desktop NatHERS support or request an on-site existing-home rating, with primary field coverage in NSW and Victoria.";
...
export default function BookAnAssessmentPage() {
  return (
    <AssessmentServicePage
      ...
      introduction="Plan-based new-home NatHERS and Whole of Home assessments can be delivered remotely across Australia. Existing-home ratings require an on-site visit and are primarily delivered in New South Wales and Victoria, with other locations confirmed case by case. Whether you searched for a NatHERS assessor, home energy assessor, existing-home energy assessment or BASIX assessor, begin with the building stage, location and purpose so we can discuss the correct pathway before supplying detailed project documents."
      ...
      coverageTitle="Remote and on-site service coverage"
      coverageDescription="Desktop NatHERS and Whole of Home services are available for projects across Australia. Existing-home visits are primarily delivered in New South Wales and Victoria, with other locations reviewed case by case."
