...
export default function CaseStudiesPage() {
  return <main className="wrap guide-page case-study-page">
    ...
    <section className="guide-callout"><div><h2>Use your own evidence</h2><p>The comparison tools keep electricity and gas separate, preserve material assumptions and show what should be confirmed before switching or buying equipment.</p></div><a href="/getting-started">Choose a comparison path</a></section>
    <footer><p>Worked examples are educational and indicative. They are not customer testimonials, current retailer quotes or guarantees of cost, savings or payback.</p><p>Provided by <a href="https://www.ausenergyassessments.com/" target="_blank" rel="noreferrer">Australian Energy Assessments</a> | Independent energy assessments | 1300 241 149</p></footer>
  </main>;
}
