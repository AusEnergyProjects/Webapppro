...
export default function GuidesPage() {
  return <GuideShell label="Learn and prepare" title="Find the right evidence without opening ten tabs" introduction="Start with the decision you are making. Each guide explains what to check, what belongs in a written quote and which official source should confirm incentives or requirements.">
    ...
    <section className="guide-callout"><div><h2>What are STCs, VEECs and other energy certificates worth?</h2><p>Learn what each certificate represents, which ones can affect household upgrade discounts and how indicative reported prices have moved over the past six months.</p></div><a href="/guides/certificate-prices">Open the certificate price tracker</a></section>
    ...
    <GuideSection eyebrow="Choose a guide" title="Start with the decision you are making"><div className="guide-card-grid">
      <article className="guide-card guide-card-wide"><span>Project preparation</span><h3>Know what the next step needs before committing</h3><p>Check urgent-replacement evidence, owner or strata permissions, renter-friendly boundaries and what each budget band should accomplish.</p><a href="/guides/project-preparation">Open the project preparation guide</a></article>
