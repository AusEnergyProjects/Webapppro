CREATE TABLE `energy_assistant_leads` (
  ...
  `service_categories_json` text NOT NULL CHECK (
    ...
    AND json_array_length(`service_categories_json`) BETWEEN 1 AND 12
...
CREATE TABLE `energy_assistant_lead_events` (
  `id` text PRIMARY KEY NOT NULL,
  `lead_id` text NOT NULL REFERENCES `energy_assistant_leads` (`id`) ON DELETE CASCADE,
