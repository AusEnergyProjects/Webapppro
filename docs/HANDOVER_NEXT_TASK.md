...
The compatibility expansion is live as Sites version 200 from pushed commit `7ebcb1905d3c28245fbcfede55525e0cfee8df8a`. It changes only `0079_trade_abn_access_gate.sql`, adds four reviewed-ABN projection fields, two indexes, the append-only review ledger and protective triggers, and leaves the version 199 runtime compatible. The reviewed-ABN application is committed as `481401d98ef2c0b294252a4cabeebc74eba40a52`, merged with the expansion release ancestry at `fb9c80fb73bf2a0b5d461ed2ecbfa28df6022c71`, and is live as Sites version 201 through deployment `appgdep_6a68baf320848191810e4a4ad5b98727` at environment revision 18.
