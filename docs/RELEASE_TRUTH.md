...
| Current executable application identity | Sites version 222 from `e74c2d95889a381cb3bb434607bc6584e54cf722` at `https://compare.ausenergyassessments.com` | Deployment `appgdep_6a6a8887a0048191b7eb1706e742ad28`; saved-version provenance, public deployment, environment revision 19 and live public route evidence verified on 30 July 2026 |
| Current source checkpoint | Documentation-only child containing this release record | Its commit and any later saved-version identity are intentionally not stated before they exist; it does not change the executable version 222 application |
...
The additive schema expansion, reviewed-ABN application, authorised contract cleanup, customer home advisor, advisor-context release, independent customer-plan release, customer plan evidence-and-history release, professional-review, browser-native PDF, premium customer-report, technical presentation and spacing releases are production. Sites version 222 is the exact executable customer-plan application source. Version 214 is historical and superseded because its signed-in action could save the project, process pending images and upload evidence before PDF generation, then attempt a delayed synthetic download. Version 216 established the non-mutating attachment path. Version 218 established the shared premium PDF and email hierarchy, version 219 recorded that release as a documentation-only historical checkpoint, and version 220 added the exact AEA mark, technical visual system, truthful completed-plan state and one non-duplicated household or professional evidence boundary. Version 222 retains those contracts while applying consistent spacing and rounded surfaces throughout PDF and email. Live verification did not create or save an account project, upload evidence, send an email or invoke native print. Earlier free-access and integration boundary checks returned `200`; retired membership, billing, referral and payment-link routes returned `404`; and an unauthenticated trade CRM request returned `401`.
...
The PDF format version is `2026-07-30-tech-presentation-pdf-v2`, the shared design version is `2026-07-30-tech-presentation-design-v2`, and the report version remains `2026-07-29-premium-report-v3`. Sites version 220 remains the historical technical-presentation source; version 222 is current.
