...
| Current saved-version identity | `appgprj_6a550c378000819185caf094173422bb~appgver_138b4cc8cf988191a4f3e4be4404a6d6` | Exact Sites version 261 built from `d441d41cad4d5299a882e73ea006a963fa360cf4`; 341 files; 30,177,280 bytes; content hash `sha256:9b6fd4e639695ea43eb2623fb495b680c6130e7d1539abb3c645b0291898c2b1` |
| Current executable application identity | Sites version 261 from `d441d41cad4d5299a882e73ea006a963fa360cf4` at `https://compare.ausenergyassessments.com/creditex/compliance` | Deployment `appgdep_6a6eb97d1978819180b729e922f33971` succeeded; environment revision 19; provider URL `https://aea-energy-comparison.info294029.chatgpt.site` |
| Current source checkpoint | Documentation-only child of `d441d41cad4d5299a882e73ea006a963fa360cf4` | This release record does not change the exact executable source for public Sites version 261 |
...
The additive schema expansion, reviewed-ABN application, authorised contract cleanup, customer, installer and trade releases, protected-trade locality, Creditex foundation, operations portal, evidence-policy governance, national government-activity workflow and isolated VEU synthetic pilot are deployed to production. Sites version 261 from `d441d41cad4d5299a882e73ea006a963fa360cf4` is the exact current executable application source. Failed versions 243, 244 and 245 never activated. Intermediate versions 247, 255, 256 and 258 exposed production-only or final usability issues during signed-in QA and were corrected before final handoff. Version 260 technically deployed but its unpreflighted guard batch rolled back when a trigger referenced a table omitted with migrations `0100` through `0105`; version 261 corrects and audits that package boundary. The release retains 32 Australian government program pathways and 207 controlled activity templates and exposes the controlled 10-installer, 30-technician, 300-job VEU pilot as a dark full-viewport compliance register with exact Dataforce interchange, post-acceptance intake and controlled source, evidence, lookup and comparison foundations. The real governed inventory remains 0 published programs, 0 activity versions, 0 policies and 0 regulated cases, and every unverified calculator and external execution path remains disabled.

## Current Creditex controlled intake foundations release
...
The current verified deployed topology for Sites version 261 is:
