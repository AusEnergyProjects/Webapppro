...
- P6-2F continues from exact Sites version 130 source and adds consent-aware service follow-up preparation, deterministic reminder drafts, staff assignment, suppression, completion and audit controls. Publication still requires exact-source validation, GitHub and Sites source pushes, Sites version creation and live provenance verification.
