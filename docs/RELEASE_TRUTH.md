...
- P6-2F was published as Sites version 131 from commit `a6f0e18f9d9e89d6ab060bde57e057196fcc94fa` on `codex/sites-custom-domain-migration`. It adds consent-aware service follow-up preparation, deterministic reminder drafts, staff assignment, suppression, completion and audit controls. The final release audit then aligned unstored customer lifecycle preferences to explicit opt-in rather than a visually checked default. Publication of that correction is pending exact-source validation and live verification.
