...
The follow-up on this branch makes the rental default a full current-minimum-standards assessment plus 2027 readiness, with practical measurements, explicit quoting readiness, trade-specific PDF schedules and regime limitations. It adds canonical electrical/plumbing capabilities with migration 0174 and simplifies the mobile job screen while fixing a dispatched-action acknowledgement race. The audit's follow-up section records scope and validation. The previous public baseline was Sites 555 at `4321271ab700ffea415d03d9e37893548cc3e60e`; the release task records publication of this subsequent source.
