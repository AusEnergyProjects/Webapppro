...
| Current Creditex VEU synthetic pilot application source | `3ac6c72057a8afea61e85817ba566ec543079886` | Exact validated source for `CREDITEX-VEU-SYNTHETIC-PILOT-28`; pushed to GitHub and Sites managed `main` |
| Current saved-version identity | `appgprj_6a550c378000819185caf094173422bb~appgver_6ead08734a6c8191b018dc5a952acd33` | Exact saved Sites version 252 built from `3ac6c72057a8afea61e85817ba566ec543079886`; package content hash `sha256:be656467751fb195f2c381c2c450df8d9bfb74256a52d29650eaebc3bfe97eaf` |
| Current executable application identity | Sites version 252 from `3ac6c72057a8afea61e85817ba566ec543079886` at `https://compare.ausenergyassessments.com/creditex/compliance` | Deployment `appgdep_6a6dd491dde88191bc862e69a2e59580` succeeded; environment revision 19; provider URL `https://aea-energy-comparison.info294029.chatgpt.site` |
| Current source checkpoint | Documentation-only child of `3ac6c72057a8afea61e85817ba566ec543079886` | This release record does not change the exact executable source for public Sites version 252 |
...
The additive schema expansion, reviewed-ABN application, authorised contract cleanup, customer, installer and trade releases, protected-trade locality, Creditex foundation, operations portal, evidence-policy governance, national government-activity workflow and isolated VEU synthetic pilot are deployed to production. Sites version 252 from `3ac6c72057a8afea61e85817ba566ec543079886` is the exact current executable application source. Failed versions 243, 244 and 245 never activated. Intermediate version 247 activated long enough for signed-in QA, exposed a production-D1 incompatibility in one aggregate query and was replaced by version 248, which is now historical. The release retains 32 Australian government program pathways and 207 controlled activity templates and adds a controlled 10-installer, 30-technician, 300-job VEU pilot. The real governed inventory remains 0 published programs, 0 activity versions, 0 policies and 0 regulated cases, and every unverified calculator and external execution path remains disabled.

## Current Creditex VEU synthetic pilot

`CREDITEX-VEU-SYNTHETIC-PILOT-28` is deployed from exact application commit `3ac6c72057a8afea61e85817ba566ec543079886` as Sites version 252. Saved version `appgprj_6a550c378000819185caf094173422bb~appgver_6ead08734a6c8191b018dc5a952acd33` reports the exact application source, and deployment `appgdep_6a6dd491dde88191bc862e69a2e59580` succeeded with environment revision 19.
...
The current verified deployed topology for Sites version 252 is:
