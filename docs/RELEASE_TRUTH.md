...
| Current saved-version identity | `appgprj_6a550c378000819185caf094173422bb~appgver_82454487760c8191b1f5338538b8fcb8` | Exact saved version 236 built from `059f2ff8d3885b3453dd38d7dee8e660fd05c4fb` |
| Current executable application identity | Sites version 236 from `059f2ff8d3885b3453dd38d7dee8e660fd05c4fb` at `https://compare.ausenergyassessments.com` | Deployment `appgdep_6a6c3b56a1b881919e82e97eaa286bc4`; saved-version provenance, public deployment and environment revision 19 verified on 31 July 2026; live signed-in and provider inbox acceptance remain incomplete |
...
The current verified deployed topology for Sites version 236 is:
...
- Opportunity-email provider: Resend configuration is present; live version-236 inbox receipt is not yet verified.
...
- Live version-236 operations and trade Resend delivery, callback and inbox receipt for a dedicated working-demo opportunity fixture.
- Measured version-236 production submit duration and immediate staged-progress presentation.
- Signed-in version-236 Leads complete-plan preview, protected PDF and complete shared-photo presentation.
