...
| Current saved-version identity | `appgprj_6a550c378000819185caf094173422bb~appgver_c9b4dbcee8408191a3fdce1aaef5548d` | Exact saved version 238 built from `35552796048df63c03409d03401d33a47f326434` |
| Current executable application identity | Sites version 238 from `35552796048df63c03409d03401d33a47f326434` at `https://compare.ausenergyassessments.com` | Deployment `appgdep_6a6c5f96df388191a5e68ffd53fb68b0`; saved-version provenance, custom-domain production deployment and environment revision 19 verified on 31 July 2026 |
| Current source checkpoint | `35552796048df63c03409d03401d33a47f326434` | Exact validated executable source for public Sites version 238; later release-record edits do not change that application identity |
...
The current verified deployed topology for Sites version 238 is:
...
- Production Resend inbox receipt for the version-238 customer quote-submitted and installer quote-accepted messages.
- Provider credentials and sender approval for the deployed Resend integration.
- Independent hosted row counts for customer-project activity events and deliveries, quote-submission ledger entries and accepted-quote claims.
