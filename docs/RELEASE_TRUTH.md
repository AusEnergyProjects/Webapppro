...
| Current executable application identity | Sites version 227 from `da35ce60295d6c7150cddd9b35e33fcf64c8521b` at `https://compare.ausenergyassessments.com` | Deployment `appgdep_6a6b22db21c48191a2dedbdbf05274ef`; saved-version provenance, public deployment, environment revision 19 and live signed-in plus health evidence verified on 30 July 2026 |
| Current source checkpoint | Documentation-only child containing this release record | Its commit and any later saved-version identity are intentionally not stated before they exist; it does not change the executable version 227 application |
...
The additive schema expansion, reviewed-ABN application, authorised contract cleanup, customer home advisor, advisor-context release, independent customer-plan release, customer plan evidence-and-history release, professional-review, browser-native PDF, premium customer-report, technical presentation, spacing, customer-plan trust and customer-project cleanup releases are production. Sites version 227 is the exact executable application source. Version 214 is historical and superseded because its signed-in action could save the project, process pending images and upload evidence before PDF generation, then attempt a delayed synthetic download. Version 216 established the non-mutating attachment path. Version 218 established the shared premium PDF and email hierarchy, version 220 added the exact AEA mark, technical visual system, truthful completed-plan state and one non-duplicated household or professional evidence boundary, and version 222 applied consistent spacing and rounded surfaces. Version 224 adds shared premium preview, duplicated bottom actions, guided private photos, bounded revision compare and restore, a tagged-PDF foundation and adaptive email compatibility. Version 227 adds compact dashboard and project-detail controls plus guarded permanent deletion for unused private drafts. Live verification opened and cancelled the confirmation dialog and inspected an existing demo project without editing or deleting it. Earlier free-access and integration boundary checks returned `200`; retired membership, billing, referral and payment-link routes returned `404`; and an unauthenticated trade CRM request returned `401`.
