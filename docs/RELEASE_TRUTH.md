...
Last reconciled locally: 2 August 2026

Deployment evidence last verified: 2 August 2026
...
| Creditex governed-operations application source | `11b06b88d68609a9fcf254877a4afe379a95f8b3` | Exact validated source for stable dark navigation, global search, source and lookup approvals, physical custody, exact-decimal calculation and exact Dataforce parallel bindings; pushed to GitHub and Sites managed `main` |
| Current saved-version identity | `appgprj_6a550c378000819185caf094173422bb~appgver_f2d304f9c9b481919b8d9588f0ef034f` | Exact Sites version 262 built from `11b06b88d68609a9fcf254877a4afe379a95f8b3`; 344 files; 30,412,800 bytes; content hash `sha256:60ede71e262e365ed8aa39fced47e8a550623266d6636ef8c326a821efdadb3c` |
| Current executable application identity | Sites version 262 from `11b06b88d68609a9fcf254877a4afe379a95f8b3` at `https://compare.ausenergyassessments.com/creditex/compliance` | Deployment `appgdep_6a6edfb2b8e08191b295825c3db65d4d` succeeded; environment revision 19; provider URL `https://aea-energy-comparison.info294029.chatgpt.site` |
| Current source checkpoint | Documentation-only child of `11b06b88d68609a9fcf254877a4afe379a95f8b3` | This release record does not change the exact executable source for public Sites version 262 |
...
The additive schema expansion, reviewed-ABN application, authorised contract cleanup, customer, installer and trade releases, protected-trade locality, Creditex foundation, operations portal, evidence-policy governance, national government-activity workflow and isolated VEU synthetic pilot are deployed to production. Sites version 262 from `11b06b88d68609a9fcf254877a4afe379a95f8b3` is the exact current executable application source. Failed versions 243, 244 and 245 never activated. Intermediate versions 247, 255, 256 and 258 exposed production-only or final usability issues during signed-in QA and were corrected before final handoff. Version 260 technically deployed but its unpreflighted guard batch rolled back when a trigger referenced a table omitted with migrations `0100` through `0105`; version 261 corrected that package boundary and version 262 adds the governed approval, physical-custody, exact-decimal calculator and exact Dataforce parallel-operation foundations. The release retains 32 Australian government program pathways and 207 controlled activity templates and exposes the controlled 10-installer, 30-technician, 300-job VEU pilot as a stable dark full-viewport compliance register with exact Dataforce interchange, post-acceptance intake and controlled source, evidence, lookup and comparison foundations. The real governed inventory remains 0 published programs, 0 activity versions, 0 policies and 0 regulated cases, and every unverified calculator and external execution path remains disabled.

## Current Creditex governed operations foundations release

`CREDITEX-GOVERNED-OPERATIONS-FOUNDATIONS-33` is the current release from exact application commit `11b06b88d68609a9fcf254877a4afe379a95f8b3`. It adds migrations `0106` through `0108`, bringing the packaged and audited inventory to 109 migrations.
...
The current verified deployed topology for Sites version 262 is:
