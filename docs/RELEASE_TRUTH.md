...
| Current saved-version identity | `appgprj_6a550c378000819185caf094173422bb~appgver_218ad21977748191a3283723f395cadd` | Exact saved version 233 built from `5acc4ccf37acd608dc437d3a074410b1d840f706` |
| Current executable application identity | Sites version 233 from `5acc4ccf37acd608dc437d3a074410b1d840f706` at `https://compare.ausenergyassessments.com` | Deployment `appgdep_6a6be56ca9ac8191918423bd57f0a05d`; saved-version provenance, public deployment, environment revision 19 and live signed-in evidence verified on 31 July 2026 |
| Current source checkpoint | Documentation-only child containing this release record | Its commit is recorded after this file is committed; it does not change the executable version 233 application |
...
The current verified deployed topology for Sites version 233 is:
