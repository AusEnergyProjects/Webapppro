...
| Current Creditex portal application source | `7b08cb600bde30273774a544e07039acc6de1c03` | Exact validated source containing the activity-agnostic portal, assignment-scoped security corrections and D1-compatible aggregates; pushed to GitHub and Sites managed `main` |
| Current saved-version identity | `appgprj_6a550c378000819185caf094173422bb~appgver_1b287ac469e88191aca7160bfa41c32c` | Exact saved version 248 built from `7b08cb600bde30273774a544e07039acc6de1c03`; package content hash `sha256:1928ee707d2076db876b6aa40e58219ae5e96273f8ee1ece08cfe74144cd2aac` |
| Current executable application identity | Sites version 248 from `7b08cb600bde30273774a544e07039acc6de1c03` at `https://compare.ausenergyassessments.com` | Deployment `appgdep_6a6d733ea23c81918f4ccd8e4f30f98b`; exact source, custom-domain production deployment and environment revision 19 verified on 1 August 2026 |
| Current source checkpoint | Documentation-only child of `7b08cb600bde30273774a544e07039acc6de1c03` | This release record does not change the exact executable source for public Sites version 248 |
...
The additive schema expansion, reviewed-ABN application, authorised contract cleanup, customer, installer and trade releases, protected-trade locality, Creditex foundation and current Creditex portal are deployed to production. Sites version 248 from `7b08cb600bde30273774a544e07039acc6de1c03` is the exact current executable application source. Failed versions 243, 244 and 245 never activated. Intermediate version 247 activated long enough for signed-in QA, exposed a production-D1 incompatibility in one aggregate query and was replaced by version 248. No production record was created or changed during either QA pass. The current release still publishes no real activity or evidence policy and keeps every unverified calculator and external execution path disabled.

## Released Creditex compliance operations portal
...
The current verified deployed topology for Sites version 248 is:
