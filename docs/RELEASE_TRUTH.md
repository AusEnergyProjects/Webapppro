...
| Current saved-version identity | `appgprj_6a550c378000819185caf094173422bb~appgver_0476874df3f081919c8e4c4acb4fd0f8` | Exact saved version 232 built from `7e1f0a85214aa505cb83ed9f8c5da9644b57df0d` |
| Current executable application identity | Sites version 232 from `7e1f0a85214aa505cb83ed9f8c5da9644b57df0d` at `https://compare.ausenergyassessments.com` | Deployment `appgdep_6a6bd28a71888191be19f89db9b82ca5`; saved-version provenance, public deployment, environment revision 19 and live signed-in evidence verified on 31 July 2026 |
| Current source checkpoint | Documentation-only child containing this release record | Its commit is recorded after this file is committed; it does not change the executable version 232 application |
...
Corrective child `7e1f0a85214aa505cb83ed9f8c5da9644b57df0d` replaces the private runtime with public `@pdf-lib/fontkit`, adds an audited production-bundle boundary and is the sole current executable source. It is saved as Sites version 232 under `appgprj_6a550c378000819185caf094173422bb~appgver_0476874df3f081919c8e4c4acb4fd0f8` and deployed through `appgdep_6a6bd28a71888191be19f89db9b82ca5` with environment revision 19.
...
The current verified deployed topology for Sites version 232 is:
