...
const styles = StyleSheet.create({
  ...
  moduleButton: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.md, borderWidth: 1, gap: 3, padding: spacing.md },
  ...
  detailsCard: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.lg, borderWidth: 1, gap: spacing.sm, padding: spacing.md },
  field: { gap: 6 },
  ...
  sectionList: { gap: 7 },
  sectionButton: { alignItems: 'center', backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.md, borderWidth: 1, flexDirection: 'row', gap: spacing.sm, minHeight: 68, padding: spacing.sm },
  ...
  sectionActions: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.lg, borderWidth: 1, gap: spacing.sm, padding: spacing.md },
  checkGroup: { gap: spacing.sm },
  itemCard: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.lg, borderWidth: 1, gap: spacing.md, padding: spacing.md },
  ...
  completionCard: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.lg, borderWidth: 1, gap: spacing.sm, padding: spacing.md },
