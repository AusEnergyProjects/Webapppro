...
const styles = StyleSheet.create({
  shell: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.md, borderWidth: 1, overflow: 'hidden' },
  ...
  saveState: { backgroundColor: colours.white, borderColor: colours.green, borderRadius: 999, borderWidth: 1, minHeight: 32, justifyContent: 'center', paddingHorizontal: spacing.sm },
  ...
  scenarioOption: { alignItems: 'center', backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.sm, borderWidth: 1, flexDirection: 'row', gap: spacing.sm, minHeight: 48, paddingHorizontal: spacing.md },
  ...
  productSearch: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.sm, borderWidth: 1, color: colours.ink, fontSize: 16, minHeight: 50, paddingHorizontal: spacing.md },
  productResults: { gap: spacing.sm },
  productCard: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.sm, borderWidth: 1, overflow: 'hidden' },
  ...
  chip: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: 999, borderWidth: 1, paddingHorizontal: spacing.md, paddingVertical: spacing.sm },
  ...
  input: { backgroundColor: colours.white, borderColor: colours.line, borderRadius: radius.sm, borderWidth: 1, color: colours.ink, fontSize: 16, minHeight: 50, paddingHorizontal: spacing.md },
  ...
  savedSignatureCard: { backgroundColor: colours.white, borderColor: colours.green, borderRadius: radius.sm, borderWidth: 2, gap: spacing.sm, padding: spacing.md },
  savedSignatureHeading: { alignItems: 'center', flexDirection: 'row', gap: spacing.sm },
  savedSignaturePlaceholder: { alignItems: 'center', backgroundColor: colours.white, borderColor: colours.green, borderRadius: radius.sm, borderWidth: 2, gap: spacing.sm, justifyContent: 'center', minHeight: 180, padding: spacing.lg },
