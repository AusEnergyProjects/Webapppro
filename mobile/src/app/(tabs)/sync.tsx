...
const styles = StyleSheet.create({
  ...
  summary: { backgroundColor: colours.surface, borderRadius: radius.lg, padding: spacing.lg, borderWidth: 1, borderColor: colours.line, gap: spacing.md },
  ...
  problem: { padding: spacing.md, borderRadius: radius.md, backgroundColor: colours.surface, borderWidth: 1, borderColor: colours.line, gap: spacing.md },
