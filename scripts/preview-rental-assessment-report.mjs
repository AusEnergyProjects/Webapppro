...
const snapshot = { schemaVersion: "tlink-rental-report-v1", preview: true,
  ...
  modules: [{ ...moduleTemplate, id: "module-1", key: "minimum_standards", title: moduleTemplate.title, completedAt: "2026-09-09T01:45:00Z", answers: { rentalRegime: "ordinary_residential", occupancyAtAssessment: "vacant", areasNotAccessed: "Illustrative limitations are shown in individual work schedules." }, sections }], findings, evidence, sources: template.sources,
};
await mkdir(dirname(output), { recursive: true });
await writeFile(output, await createRentalAssessmentPdfBytes(snapshot, assets));
console.log(output);
