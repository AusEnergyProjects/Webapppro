...
export const CREDITEX_CERTIFICATE_ACTIVATION_ACTIVITY_COUNT = 196;
...
if (
  ...
  throw new Error(
    "Certificate activation gate configuration is invalid: the release catalogue must contain exactly 196 unique current or limited activity IDs.",
  );
}
