...
test("quote SQL compiles against its production migration dependencies", () => {
  ...
  for (const file of ["0000_complex_absorbing_man.sql", "0001_futuristic_frog_thor.sql", "0011_even_reavers.sql", "0015_aromatic_black_knight.sql", "0019_melodic_unus.sql", "0047_customer_service_site_foundation.sql", "0050_versioned_trade_quotes.sql"]) apply(db, fs.readFileSync(new URL(file, directory), "utf8"));
