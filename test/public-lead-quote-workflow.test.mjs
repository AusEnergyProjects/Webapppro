...
test("public lead save, issue and send use one immutable accepted recipient", () => {
  ...
  assert.match(quoteRoute, /\["replace_link", "revoke_link", "send_quote", "answer_question"\][\s\S]*authorisedEmails\(access\.ownerUid, String\(job\.crm_customer_id\), acceptedPublicEmail\(job\)\)/);
