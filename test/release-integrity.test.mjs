...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Current personalised plan and open trade lead application source \| `59ea305f9a45d1e4c22b354af2e211d22fe11358`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 303 from `59ea305f9a45d1e4c22b354af2e211d22fe11358`/);
  ...
  assert.match(releaseTruth, /Current Google Apps Script relay identity \| Version 11 deployment `AKfycbxBjHL_I3aw0FsGkOVaUDic6AwW1W0ItuxadP1NF-0NolTwLahYnc9PsGpPAdv2tMqW`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 303 is:/);
  ...
  assert.match(roadmap, /59ea305f9a45d1e4c22b354af2e211d22fe11358[\s\S]{0,180}Sites version 303/);
  ...
  assert.match(roadmap, /runOperationalHealthCheck[\s\S]{0,280}910bf1b2-1b7d-4ad5-951f-7f71ffdc79ed/);
  assert.match(roadmap, /site-release-59ea305\.tar\.gz[\s\S]{0,160}11,501,890 bytes/);
  assert.match(roadmap, /8fd77af8de6264dc3b8ea662851d3f4451c0315aa188b756a3e8380984c02a11/);
  ...
  assert.match(handover, /Released application source: `59ea305f9a45d1e4c22b354af2e211d22fe11358`/);
  ...
  assert.match(handover, /Previous production application source: `f797ab7ee447bc31d66b5760f6613e46f107e97d`/);
  ...
  assert.match(handover, /Current production source: `59ea305f9a45d1e4c22b354af2e211d22fe11358`/);
  assert.match(handover, /Current production: Sites version 303 from application commit `59ea305f9a45d1e4c22b354af2e211d22fe11358`/);
  assert.match(handover, /appgprj_6a550c378000819185caf094173422bb~appgver_83ae907840f48191844403ab5575a1d9/);
  assert.match(handover, /appgdep_6a7955e575008191b9cd07b1beff2df9/);
  assert.match(handover, /65b5aa69eb0d4087d9cd3fb0b56fb0febdfb9972cd78b50c5f25cc9f5a680e32/);
  assert.match(handover, /391 files, 37,160,960 bytes/);
  assert.match(handover, /Environment revision: 20/);
  assert.match(handover, /site-release-59ea305\.tar\.gz[\s\S]{0,160}11,501,890 bytes/);
  assert.match(handover, /8fd77af8de6264dc3b8ea662851d3f4451c0315aa188b756a3e8380984c02a11/);
  ...
  assert.match(releaseTruth, /installed `sendFollowUps` and\s+`runOperationalHealthCheck` triggers were present with 0% error/);
  assert.match(releaseTruth, /1,309 by 818 desktop viewport[\s\S]{0,180}scroll width and client width were both 1,295 pixels/);
  assert.match(releaseTruth, /355 by 767 mobile viewport[\s\S]{0,180}scroll width and client width were both 341 pixels/);
  ...
  assert.match(sourceRegister, /Sites version 303/);
  assert.match(sourceRegister, /59ea305f9a45d1e4c22b354af2e211d22fe11358/);
  assert.match(sourceRegister, /appgprj_6a550c378000819185caf094173422bb~appgver_83ae907840f48191844403ab5575a1d9/);
  assert.match(sourceRegister, /appgdep_6a7955e575008191b9cd07b1beff2df9/);
  ...
  assert.match(sourceRegister, /sendFollowUps` and `runOperationalHealthCheck` triggers reported 0% error/);
  ...
  assert.match(normalisedRoadmapNextFive, /^1\. Obtain authorised read-only R2 bytes and exact-diff held GEMS 7,500-to-7,499 change\./);
