...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Current Creditex evidence-policy governance application source \| `d40c803bfa0b614ed806624a375a1fa47bd0e5a4`/);
  assert.match(releaseTruth, /Sites version 249 from `d40c803bfa0b614ed806624a375a1fa47bd0e5a4`/);
  ...
  assert.match(handover, /Status: `CREDITEX-EVIDENCE-POLICY-GOVERNANCE-26` released/);
  assert.match(handover, /Milestone ID: `CREDITEX-EVIDENCE-POLICY-GOVERNANCE-26`/);
  assert.match(handover, /Current production: Sites version 249 from application commit `d40c803bfa0b614ed806624a375a1fa47bd0e5a4`/);
