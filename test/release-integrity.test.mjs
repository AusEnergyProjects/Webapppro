...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /## Current trade workspace delivery-recovery release/);
  ...
  assert.match(releaseTruth, /Current trade-workspace delivery-recovery application source \| `9c278bb23f3f5eb9c3878c5a4cfc946264f1a29c`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 282 from `9c278bb23f3f5eb9c3878c5a4cfc946264f1a29c`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 282 is:/);
  ...
  assert.match(handover, /Current production: Sites version 282 from application commit `9c278bb23f3f5eb9c3878c5a4cfc946264f1a29c`/);
  assert.match(handover, /appgprj_6a550c378000819185caf094173422bb~appgver_fd653b2ad83c81918fd23a3366735271/);
  assert.match(handover, /appgdep_6a71e7f3af3c81918f0f89a3e0354d36/);
  assert.match(handover, /7,829,193 bytes/);
  assert.match(handover, /EC1B166DD9957DA17C4F889E4802C349A76A71454627769D12B5BFD5A1E503E2/);
  assert.match(handover, /361 files and 31,907,840 bytes/);
  assert.match(handover, /sha256:86f36c8d918da0ae1b634db811ed645a27d4a50a1a35acc0eba79d5e20488d96/);
  assert.match(handover, /1,466 main tests with 1,464\s+passed, 2 intentionally skipped and 0 failed/);
  ...
  assert.match(normalisedRoadmapNextFive, /^1\. \*\*Prove production quote delivery end to end:/);
  assert.match(normalisedRoadmapNextFive, /\n2\. \*\*Approve one complete VEU, SRES and NSW governed bundle each:/);
  assert.match(normalisedRoadmapNextFive, /\n3\. \*\*Configure one approved Australian production address provider:/);
  assert.match(normalisedRoadmapNextFive, /\n4\. \*\*Complete immutable intent revision and case supersession:/);
  assert.match(normalisedRoadmapNextFive, /\n5\. \*\*Complete physical field and Dataforce acceptance:/);
});
