...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Sites version 214 from `d5c675a5ceffa6e924df033e8cb8b505bb4d6336`/);
  assert.match(releaseTruth, /2026-07-29-direct-download-pdf-v1/);
  assert.match(releaseTruth, /direct PDF downloads that avoid browser print APIs/);
  ...
  assert.match(roadmap, /Release status: application commit `d5c675a5ceffa6e924df033e8cb8b505bb4d6336`[\s\S]{0,250}Sites version 214/);
  assert.match(handover, /Status: released implementation milestone/);
  assert.match(handover, /Milestone ID: `CUSTOMER-PLAN-DIRECT-PDF-06`/);
  assert.match(handover, /Released application for this milestone: Sites version 214 from application commit `d5c675a5ceffa6e924df033e8cb8b505bb4d6336`/);
  assert.match(handover, /Sites application version: 214/);
  assert.match(handover, /2026-07-29-direct-download-pdf-v1/);
