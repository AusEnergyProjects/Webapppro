...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Sites version 232 from `7e1f0a85214aa505cb83ed9f8c5da9644b57df0d`/);
  ...
  assert.match(handover, /Milestone ID: `CUSTOMER-PLAN-DURABILITY-15`/);
  assert.match(handover, /Released application for this milestone: Sites version 232 from application commit `7e1f0a85214aa505cb83ed9f8c5da9644b57df0d`/);
  assert.match(handover, /Sites application version: 232/);
