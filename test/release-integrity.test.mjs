...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Sites version 229 from `0db488f325a79e22d126aace75647715b59c96f9`/);
  ...
  assert.match(handover, /Milestone ID: `CUSTOMER-ROADMAP-CONTEXT-13`/);
  assert.match(handover, /Released application for this milestone: Sites version 229 from application commit `0db488f325a79e22d126aace75647715b59c96f9`/);
  assert.match(handover, /Sites application version: 229/);
  assert.match(handover, /appgdep_6a6b38fcccbc8191b8b2daedf57b9e24/);
