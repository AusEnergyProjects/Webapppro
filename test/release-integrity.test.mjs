...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Current immersive plan action handoff application source \| `f797ab7ee447bc31d66b5760f6613e46f107e97d`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 302 from `f797ab7ee447bc31d66b5760f6613e46f107e97d`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 302 is:/);
  ...
  assert.match(roadmap, /## Released milestone: AEA-IMMERSIVE-PLAN-ACTION-HANDOFF-50/);
  ...
  assert.match(handover, /Milestone ID: `AEA-IMMERSIVE-PLAN-ACTION-HANDOFF-50`/);
  assert.match(handover, /Released application source: `f797ab7ee447bc31d66b5760f6613e46f107e97d`/);
  assert.match(handover, /## Released milestone: AEA-IMMERSIVE-PLAN-ACTION-HANDOFF-50/);
  ...
  assert.match(handover, /Previous production application source: `bc4096d61cb493e819555d72113d0c77d45a1653`/);
  ...
  assert.match(handover, /Current production source: `f797ab7ee447bc31d66b5760f6613e46f107e97d`/);
  assert.match(handover, /Current production: Sites version 302 from application commit `f797ab7ee447bc31d66b5760f6613e46f107e97d`/);
  ...
  assert.match(handover, /no-account basic enquiry[\s\S]{0,140}`Create free account`/);
  assert.match(handover, /No lead was submitted/);
  ...
  assert.match(releaseTruth, /## Current immersive plan action handoff release/);
  ...
  assert.match(sourceRegister, /Sites version 302/);
  ...
  assert.match(sourceRegister, /semantic\s+four-stage journey[\s\S]{0,120}without WebGL,\s+canvas or video/);
  assert.match(sourceRegister, /`Open wall vents` from `Open or unused chimney or flue`/);
  assert.match(sourceRegister, /no duplicate `Heat-pump space heating` option/);
  assert.match(sourceRegister, /no-account basic enquiry[\s\S]{0,120}`Create free account`/);
  assert.match(sourceRegister, /hold_for_authority_review[\s\S]{0,80}autoSend: false/);
  assert.match(sourceRegister, /hosted\s+deployment remains unverified/);
  assert.match(sourceRegister, /No lead was submitted during QA/);
