...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Current customer-plan PDF-font corrective source \| `79f7e2e5be14464410ba40a749453c7473b22d4d`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 305 from `79f7e2e5be14464410ba40a749453c7473b22d4d`/);
  ...
  assert.match(releaseTruth, /Current Google Apps Script relay identity \| Version 12 deployment `AKfycbxBjHL_I3aw0FsGkOVaUDic6AwW1W0ItuxadP1NF-0NolTwLahYnc9PsGpPAdv2tMqW`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 305 is:/);
  ...
  assert.match(roadmap, /## Released milestone: AEA-PERSONALISED-PLAN-OPEN-TRADE-LEADS-51/);
  ...
  assert.match(handover, /Milestone ID: `AEA-PERSONALISED-PLAN-OPEN-TRADE-LEADS-51`/);
  assert.match(handover, /Milestone application source: `a0fcbf200ece76f68bbd83c298f1d556333c615e`/);
  assert.match(handover, /Released application source: `79f7e2e5be14464410ba40a749453c7473b22d4d`/);
  assert.match(handover, /## Released milestone: AEA-PERSONALISED-PLAN-OPEN-TRADE-LEADS-51/);
  ...
  assert.match(handover, /Previous production application source: `59ea305f9a45d1e4c22b354af2e211d22fe11358`/);
  ...
  assert.match(handover, /Current production source: `79f7e2e5be14464410ba40a749453c7473b22d4d`/);
  assert.match(handover, /Current production: Sites version 305 from application commit `79f7e2e5be14464410ba40a749453c7473b22d4d`/);
  assert.match(handover, /appgprj_6a550c378000819185caf094173422bb~appgver_248c3d6df9448191b171e990ac8dfdd1/);
  assert.match(handover, /appgdep_6a797f25df8c819187590b70811a6794/);
  assert.match(handover, /e2869ae853c4e927c32799128bb83133c7a3d1974effd60ed23baacec5ae6976/);
  assert.match(handover, /391 files, 37,201,920 bytes/);
  ...
  assert.match(releaseTruth, /## Current personalised plan and open trade lead release/);
  ...
  assert.match(sourceRegister, /Sites version 305/);
  ...
  assert.match(normalisedRoadmapNextFive, /^1\. Exact-diff the held GEMS 7,500-to-7,499 source change against authorised retained bytes\./);
