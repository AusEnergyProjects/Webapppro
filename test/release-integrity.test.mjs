...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Sites version 230 from `2607cc53f2e4c79546701e29d3d182fde4670952`/);
  ...
  assert.match(handover, /Milestone ID: `CUSTOMER-INSTALLER-REQUEST-14`/);
  assert.match(handover, /Released application for this milestone: Sites version 230 from application commit `2607cc53f2e4c79546701e29d3d182fde4670952`/);
  assert.match(handover, /Sites application version: 230/);
  assert.match(handover, /appgprj_6a550c378000819185caf094173422bb~appgver_52a74079cae481918a86072452749e99/);
  assert.match(handover, /appgdep_6a6b5469c8bc81919f0e2c9ef22da602/);
