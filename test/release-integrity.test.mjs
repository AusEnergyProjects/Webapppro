...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(handover, /Milestone ID: `CUSTOMER-PLAN-TRADE-ENQUIRY-22`/);
  assert.match(handover, /Released application for this milestone: Sites version 240 from application commit `b40c101939eec44b178b34ccb6397a989d2467d0`/);
  assert.match(handover, /Sites application version: 240/);
