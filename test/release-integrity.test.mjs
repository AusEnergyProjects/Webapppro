...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /## Current trade multi-activity usability release/);
  ...
  assert.match(releaseTruth, /Current multi-activity application source \| `13dbf2ddc4eea32c6a929ef15cb258a263ff99ea`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 279 from `13dbf2ddc4eea32c6a929ef15cb258a263ff99ea`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 279 is:/);
  ...
  assert.match(handover, /Previous production application source: `c51934456c2248da4cfde9a0b759b70d69df56ee`/);
  assert.match(handover, /Released application source: `13dbf2ddc4eea32c6a929ef15cb258a263ff99ea`/);
  assert.match(handover, /Current production: Sites version 279 from application commit `13dbf2ddc4eea32c6a929ef15cb258a263ff99ea`/);
