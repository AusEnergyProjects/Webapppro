...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Sites version 212 from `ee75aadfd6800c01b92532b2d376a4a1e33c9d74`/);
  ...
  assert.match(roadmap, /Release status: application commit `ee75aadfd6800c01b92532b2d376a4a1e33c9d74`[\s\S]{0,250}Sites version 212/);
  assert.match(handover, /Status: released implementation milestone/);
  assert.match(handover, /Milestone ID: `CUSTOMER-PLAN-PRO-PRINT-05`/);
  assert.match(handover, /Released application for this milestone: Sites version 212 from application commit `ee75aadfd6800c01b92532b2d376a4a1e33c9d74`/);
  assert.match(handover, /Sites application version: 212/);
