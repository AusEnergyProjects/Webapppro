...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Sites version 233 from `5acc4ccf37acd608dc437d3a074410b1d840f706`/);
  ...
  assert.match(handover, /Milestone ID: `CUSTOMER-INSTALLER-PHOTOS-16`/);
  assert.match(handover, /Released application for this milestone: Sites version 233 from application commit `5acc4ccf37acd608dc437d3a074410b1d840f706`/);
  assert.match(handover, /Sites application version: 233/);
  assert.match(handover, /appgprj_6a550c378000819185caf094173422bb~appgver_218ad21977748191a3283723f395cadd/);
  assert.match(handover, /appgdep_6a6be56ca9ac8191918423bd57f0a05d/);
