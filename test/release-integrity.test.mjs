...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Current immersive customer journey application source \| `bc4096d61cb493e819555d72113d0c77d45a1653`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 301 from `bc4096d61cb493e819555d72113d0c77d45a1653`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 301 is:/);
  ...
  assert.match(roadmap, /## Released milestone: AEA-IMMERSIVE-CUSTOMER-JOURNEY-49/);
  ...
  assert.match(handover, /Milestone ID: `AEA-IMMERSIVE-CUSTOMER-JOURNEY-49`/);
  assert.match(handover, /Released application source: `bc4096d61cb493e819555d72113d0c77d45a1653`/);
  assert.match(handover, /## Released milestone: AEA-IMMERSIVE-CUSTOMER-JOURNEY-49/);
  assert.match(handover, /## Previous released milestone: AEA-CALCULATOR-USABILITY-AUTHORITY-48/);
  assert.match(handover, /Previous production application source: `ca3d84a497258426c7ab34c87e8059df1cba2a27`/);
  ...
  assert.match(handover, /Current production source: `bc4096d61cb493e819555d72113d0c77d45a1653`/);
  assert.match(handover, /Current production: Sites version 301 from application commit `bc4096d61cb493e819555d72113d0c77d45a1653`/);
  ...
  assert.match(releaseTruth, /## Current immersive customer journey and mixed water-heater quote release/);
  ...
  assert.match(sourceRegister, /Sites version 301/);
  ...
  assert.match(sourceRegister, /semantic lightweight CSS and HTML[\s\S]{0,120}no canvas, WebGL or video/);
  assert.match(sourceRegister, /mixed exact approved SRES solar-water-heater and\s+air-source-heat-pump rows and VEU 1C, 1D, 3C and 3D rows/);
  assert.match(sourceRegister, /Strict compliance remains fail-closed at one unit/);
  assert.match(sourceRegister, /no signed-in v301\s+dashboard QA is claimed/);
  ...
  assert.match(normalisedRoadmapNextFive, /^1\. Obtain authorised read-only R2 bytes and exact-diff the held GEMS 7,500-to-7,499 change\./);
