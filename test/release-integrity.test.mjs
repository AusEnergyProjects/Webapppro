...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /## Current Creditex governed manual-field preflight release/);
  ...
  assert.match(releaseTruth, /Current Creditex application source \| `5d4b540dcbcb49b3d1d57eda122a4dca86d723bb`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 268 from `5d4b540dcbcb49b3d1d57eda122a4dca86d723bb`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 268 is:/);
  ...
  assert.match(handover, /Status: `CREDITEX-GOVERNED-MANUAL-FIELD-PREFLIGHT-37` released and live/);
  assert.match(handover, /Milestone ID: `CREDITEX-GOVERNED-MANUAL-FIELD-PREFLIGHT-37`/);
  assert.match(handover, /Current production: Sites version 268 from application commit `5d4b540dcbcb49b3d1d57eda122a4dca86d723bb`/);
  assert.match(handover, /Released application source commit: `5d4b540dcbcb49b3d1d57eda122a4dca86d723bb`/);
  assert.match(handover, /Primary application source commit: `8c29808a9f4a80acc8e7f2304c4b49268f4f2c49`/);
  assert.match(handover, /Previous production application source: `ecec39abbc65fb5d25aa5d21d6dcfead724bcc0f`/);
