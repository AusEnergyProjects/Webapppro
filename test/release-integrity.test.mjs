...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /## Current Creditex national calculation foundations release/);
  ...
  assert.match(releaseTruth, /Current executable application identity \| Sites version 265 from `5eab88950c1047746484ce2ab4880d8e32be824a`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 265 is:/);
  ...
  assert.match(handover, /Status: `CREDITEX-NATIONAL-CALCULATION-FOUNDATIONS-35` released and live/);
  assert.match(handover, /Milestone ID: `CREDITEX-NATIONAL-CALCULATION-FOUNDATIONS-35`/);
  assert.match(handover, /Current production: Sites version 265 from application commit `5eab88950c1047746484ce2ab4880d8e32be824a`/);
  assert.match(handover, /Released application source commit: `5eab88950c1047746484ce2ab4880d8e32be824a`/);
  assert.match(handover, /Primary application source commit: `5eab88950c1047746484ce2ab4880d8e32be824a`/);
  assert.match(handover, /Previous production application source: `31b152933273db33bfa866bdbc491f6fdc35360a`/);
  ...
  assert.match(roadmapNextFive, /^1\. \*\*Retain and approve the exact current rule packs:/);
  assert.match(roadmapNextFive, /\n2\. \*\*Replace manual inputs with official effective-dated lookups:/);
  assert.match(roadmapNextFive, /\n3\. \*\*Implement reviewed VEU and NSW calculation drafts:/);
  assert.match(roadmapNextFive, /\n4\. \*\*Build authorised submission interchange:/);
  assert.match(roadmapNextFive, /\n5\. \*\*Connect installer cases to field evidence custody:/);
});
