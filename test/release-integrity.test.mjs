...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /## Current trade business identity and quote-delivery release/);
  ...
  assert.match(releaseTruth, /Current business-identity and quote-delivery application source \| `fcfca482b0f86413423af2af8c5ae77054e6186f`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 280 from `fcfca482b0f86413423af2af8c5ae77054e6186f`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 280 is:/);
  ...
  assert.match(handover, /Milestone ID: `TRADE-BUSINESS-IDENTITY-QUOTE-DELIVERY-43`/);
  assert.match(handover, /Previous production application source: `13dbf2ddc4eea32c6a929ef15cb258a263ff99ea`/);
  assert.match(handover, /Released application source: `fcfca482b0f86413423af2af8c5ae77054e6186f`/);
  assert.match(handover, /Current production: Sites version 280 from application commit `fcfca482b0f86413423af2af8c5ae77054e6186f`/);
  assert.match(handover, /appgprj_6a550c378000819185caf094173422bb~appgver_a6468ced690881919d2e29c591fd11f3/);
  assert.match(handover, /appgdep_6a71bf0136dc81918e71ba815cddd0ff/);
  assert.match(handover, /7,833,168 bytes/);
  assert.match(handover, /806E919D9144B30A162C051660444F82F7BEAFE542EEBEB954C742675161139B/);
  assert.match(handover, /361 files and 31,856,640 bytes/);
  assert.match(handover, /sha256:cf01b5bdf49058a7b12e7177e864c08a17af1203dc23f1e4b22a10ce5d7dcc2c/);
  assert.match(handover, /1,457 main tests with 1,455 passed, 2 intentionally\s+skipped\s+and 0 failed/);
