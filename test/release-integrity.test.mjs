...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /## Current Creditex national manual-evidence lab release/);
  ...
  assert.match(releaseTruth, /Current executable application identity \| Sites version 266 from `ecec39abbc65fb5d25aa5d21d6dcfead724bcc0f`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 266 is:/);
  ...
  assert.match(handover, /Status: `CREDITEX-NATIONAL-MANUAL-EVIDENCE-LAB-36` released and live/);
  assert.match(handover, /Milestone ID: `CREDITEX-NATIONAL-MANUAL-EVIDENCE-LAB-36`/);
  assert.match(handover, /Current production: Sites version 266 from application commit `ecec39abbc65fb5d25aa5d21d6dcfead724bcc0f`/);
  assert.match(handover, /Released application source commit: `ecec39abbc65fb5d25aa5d21d6dcfead724bcc0f`/);
  assert.match(handover, /Primary application source commit: `ecec39abbc65fb5d25aa5d21d6dcfead724bcc0f`/);
  assert.match(handover, /Previous production application source: `5eab88950c1047746484ce2ab4880d8e32be824a`/);
  ...
  assert.match(roadmapNextFive, /^1\. \*\*Connect the physical field-test path:/);
  assert.match(roadmapNextFive, /\n2\. \*\*Merge government policy without weakening it:/);
  assert.match(roadmapNextFive, /\n3\. \*\*Unify manual jobs with the Creditex audit workflow:/);
  assert.match(roadmapNextFive, /\n4\. \*\*Build regulator interchange dry runs:/);
  assert.match(roadmapNextFive, /\n5\. \*\*Complete source-approved calculation coverage:/);
});
