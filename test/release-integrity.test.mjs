...
test("the dated audit is immutable evidence and current truth has one documented owner per concern", () => {
  ...
  assert.match(releaseTruth, /Current calculator usability and product-authority application source \| `ca3d84a497258426c7ab34c87e8059df1cba2a27`/);
  assert.match(releaseTruth, /Current executable application identity \| Sites version 300 from `ca3d84a497258426c7ab34c87e8059df1cba2a27`/);
  ...
  assert.match(releaseTruth, /The current verified deployed topology for Sites version 300 is:/);
  ...
  assert.match(roadmap, /## Released milestone: AEA-CALCULATOR-USABILITY-AUTHORITY-48/);
  ...
  assert.match(handover, /Released application source: `ca3d84a497258426c7ab34c87e8059df1cba2a27`/);
  assert.match(handover, /## Released milestone: AEA-CALCULATOR-USABILITY-AUTHORITY-48/);
  assert.match(handover, /Previous production application source: `c9fb34115209c0ea0a1fc02ee2095250458c256f`/);
  ...
  assert.match(handover, /Current production source: `ca3d84a497258426c7ab34c87e8059df1cba2a27`/);
  assert.match(handover, /Current production: Sites version 300 from application commit `ca3d84a497258426c7ab34c87e8059df1cba2a27`/);
  ...
  assert.match(releaseTruth, /## Current calculator usability and product-authority release/);
  ...
  assert.match(sourceRegister, /Sites version\s+300/);
  ...
  assert.match(sourceRegister, /Version-300 administrator QA activated that TESSA snapshot as current/);
  ...
  assert.match(sourceRegister, /no GEMS-backed\s+calculator is active or current while that retained-byte review is unresolved/);
