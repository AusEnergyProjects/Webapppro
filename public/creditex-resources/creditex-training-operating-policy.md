...
## Declarations, evidence and exceptions

Use current controlled, scheme-specific forms. Each declaration must identify the true signer, their authority and the real dates and facts. Never copy signatures, sign for an absent person or backdate a declaration. A form from another programme does not transfer the required rights.

Preserve original evidence and capture metadata where collected. Link evidence to the specific installation and premises. Keep corrections as traceable revisions. If equipment, site conditions, ownership, proposed dates or scope change, pause the programme commitment and obtain a revised eligibility and evidence decision. Do not treat a quotation, product advertisement or a prior job as proof of this implementation.

For multiple incentives, separately check each programme's eligibility, assignment, payment and duplicate-claim rules. Record external administrator or provider acceptance separately from local job completion. Escalate complaints, suspected false evidence, unsafe work and missing authority to Creditex while preserving the relevant records.

## Source attribution

The course notes are adapted summaries and original assessment questions, with changes for training presentation. They are not regulator-authored or regulator-endorsed training.

Based on Clean Energy Regulator material licensed under a [Creative Commons Attribution 4.0 licence](https://creativecommons.org/licenses/by/4.0/). See [CER copyright](https://cer.gov.au/about-us/our-policies/copyright) and each course's specific source links.

Victorian source material: © Copyright State of Victoria (Department of Energy, Environment and Climate Action), used under [Creative Commons Attribution 4.0](https://creativecommons.org/licenses/by/4.0/), where indicated by the source publication. See [Solar Victoria copyright](https://www.solar.vic.gov.au/copyright). Government logos, branding and photographs are not reproduced as course branding.

The supplied Creditex documents were treated as source material for review. Historical forms containing inconsistent identifiers, outdated provisions or another activity's instructions have not been made current mandatory declarations by this policy.
