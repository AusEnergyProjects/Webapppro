...
- P6-2K adds required structured property context, consented phone or tablet photo capture, R2-backed evidence and installer-owned arrival windows. Quoting photos are shared with every active verified installer allocated to the exact enquiry, while identity, contact details, exact location, private notes and supporting documents remain protected. Only the accepted connected installer can view supporting documents, propose arrival windows or convert the platform lead into a CRM job. Customer selection records a revisioned preference and does not create an appointment.
