...
- Assigned native jobs now sync technical form names and completion states into the encrypted offline payload. Offline form editing remains the next native contract extension.
