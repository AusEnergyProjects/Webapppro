...
export const tradeRentalInspections = sqliteTable("trade_rental_inspections", {
  ...
  check("trade_rental_inspections_modules_check", sql`json_valid(${table.moduleSelectionSnapshot}) AND json_type(${table.moduleSelectionSnapshot}) = 'array' AND json_array_length(${table.moduleSelectionSnapshot}) BETWEEN 1 AND 4 AND json_extract(${table.moduleSelectionSnapshot}, '$[0]') IN ('minimum_standards', 'electrical_safety_check', 'gas_safety_check', 'smoke_alarm_check') AND coalesce(json_extract(${table.moduleSelectionSnapshot}, '$[1]'), '') IN ('', 'minimum_standards', 'electrical_safety_check', 'gas_safety_check', 'smoke_alarm_check') AND coalesce(json_extract(${table.moduleSelectionSnapshot}, '$[2]'), '') IN ('', 'minimum_standards', 'electrical_safety_check', 'gas_safety_check', 'smoke_alarm_check') AND coalesce(json_extract(${table.moduleSelectionSnapshot}, '$[3]'), '') IN ('', 'minimum_standards', 'electrical_safety_check', 'gas_safety_check', 'smoke_alarm_check') AND (json_array_length(${table.moduleSelectionSnapshot}) < 2 OR json_extract(${table.moduleSelectionSnapshot}, '$[1]') <> json_extract(${table.moduleSelectionSnapshot}, '$[0]')) AND (json_array_length(${table.moduleSelectionSnapshot}) < 3 OR json_extract(${table.moduleSelectionSnapshot}, '$[2]') NOT IN (json_extract(${table.moduleSelectionSnapshot}, '$[0]'), json_extract(${table.moduleSelectionSnapshot}, '$[1]'))) AND (json_array_length(${table.moduleSelectionSnapshot}) < 4 OR json_extract(${table.moduleSelectionSnapshot}, '$[3]') NOT IN (json_extract(${table.moduleSelectionSnapshot}, '$[0]'), json_extract(${table.moduleSelectionSnapshot}, '$[1]'), json_extract(${table.moduleSelectionSnapshot}, '$[2]')))`),
