...
export const tradeTeamMemberCredentials = sqliteTable("trade_team_member_credentials", {
  ...
  check("trade_team_member_credentials_type_check", sql`${table.credentialType} IN ('licence', 'registration', 'training', 'insurance', 'other')`),
  check("trade_team_member_credentials_rental_gate_check", sql`${table.rentalGate} IN ('', 'licensed_electrician', 'licensed_gasfitter', 'suitably_qualified_smoke_alarm_worker')`),
